...
/**
 * @file cf_pinout.h
 * @brief pinout definition for the NRF51822 on the Crazyflie 2.1
 * @author Lan HUANG(YelloooBlue@outlook.com)
 * @date June 2024
 *
 * This file contains the pinout definition for the NRF51822 on the Crazyflie 2.1.
 */ 


#ifndef __CF_PINOUT_H__
#define __CF_PINOUT_H__

#ifndef DEBUG_UART                    // pins connected to the STM32F4
#define UART_RX_PIN 30
#define UART_TX_PIN 29
#define UART_RTS_PIN 14
#else                                 // pins are exposed to the outside on the board 
