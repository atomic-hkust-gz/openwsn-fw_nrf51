...
// nrf51-DK (pca100028)
#define LED_1           NRF_GPIO_PIN_MAP(0,21)
...
void leds_init() {
    ...
    NRF_GPIO->DIRSET = 1<<LED_2;
    NRF_GPIO->DIRSET = 1<<LED_3;
    NRF_GPIO->DIRSET = 1<<LED_4;
