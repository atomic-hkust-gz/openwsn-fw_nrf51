...
#define LFCLKSTAT_SRC_POS     0    //CLOCK_LFCLKSTAT_SRC_Pos
#define LFCLKSTAT_STATE_POS   16   //CLOCK_LFCLKSTAT_STATE_Pos
...
void sctimer_init(void) {
    ...
    NVIC->IP[SWI0_IRQn]         = (uint8_t)((RTC_PRIORITY << (8 - __NVIC_PRIO_BITS)) & (uint32_t)0xFF);
    NVIC->ISER[SWI0_IRQn>>5]    = (uint32_t)(0x1 << (SWI0_IRQn & 0x1f));
